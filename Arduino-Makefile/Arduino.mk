...
ifndef ARDMK_DIR
    ...
    ARDMK_DIR := $(realpath $(dir $(realpath $(lastword $(MAKEFILE_LIST)))))/Arduino-Makefile
else
...
ifndef ARDUINO_LIB_PATH
    ARDUINO_LIB_PATH = $(PROJECT_DIR)/arduino-libraries/libraries
...
ifndef ARDUINO_PLATFORM_LIB_PATH
    ARDUINO_PLATFORM_LIB_PATH = $(PROJECT_DIR)/arduino-libraries/libraries
else
...
ifndef ARDUINO_VAR_PATH
    ARDUINO_VAR_PATH  = $(PROJECT_DIR)/arduino-libraries/variants
...
ifeq ($(strip $(NO_CORE)),)
    ...
    ifndef BOOTLOADER_FILE
        ...
        $(call show_config_variable,BOOTLOADER_FILE,[BOOTLOADER_FILE])
    endif
...
ifndef ARDUINO_CORE_PATH
	ARDUINO_CORE_PATH = $(PROJECT_DIR)/arduino-libraries/arduino
else
...
ifndef ARDUINO_LIBS
    ...
    ARDUINO_LIBS += $(filter $(notdir $(wildcard $(PROJECT_DIR)/arduino-libraries/libraries/*)), \
...
ifndef BOOTLOADER_PARENT
    BOOTLOADER_PARENT = $(PROJECT_DIR)/arduino-libraries/bootloaders
